...
- follow one BA-friendly setup path from laptop setup to first prototype change
...
1. [BA setup guide](ba-setup-guide.md)
2. [Windows setup](windows-setup.md) or [Mac setup](macbook-setup.md) if you need deeper operating-system detail
3. [Git and GitHub basics](git-and-github.md)
4. [Using Codex for prototyping](using-codex.md)
5. [Accessible BA-led prototyping](accessible-prototyping.md)
6. [Prototype output pack](prototype-output-pack.md)
